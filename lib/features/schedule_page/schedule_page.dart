...
class SchedulePage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final scheduleWeeks = ScheduleDateCreator().createSchedule(DateTime(2024, 2, 10));
    final selectedDate = useState(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day));
